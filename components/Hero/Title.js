    ...
    return (
        <>
            <div className='overflow-hidden px-[10vw]'>
                <h1 className='tracking-[-.1em] text-[17vw] md:text-[14vw] leading-none duration-1000'
                    style={{ transform: `translate3d(0px, ${titleMoving}%, 0px)` }}
                >SPRING</h1>
            </div>
            <div className='flex justify-end overflow-hidden relative -top-[6vw]  md:-top-[3.55vw] px-[10vw] pt-7'>
                <h1 ref={ref} className='tracking-[-.11em] text-[17vw] md:text-[14vw] leading-none  duration-1000'
                    style={{ transform: `translate3d(0px, ${titleMoving}%, 0px)` }}
                >SUMMER</h1>
